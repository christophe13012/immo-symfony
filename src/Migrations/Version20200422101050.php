 ...
 */
final class Version20200422101050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE search (id INT AUTO_INCREMENT NOT NULL, city VARCHAR(255) DEFAULT NULL, max_surface INT DEFAULT NULL, min_surface INT DEFAULT NULL, min_price INT DEFAULT NULL, max_price INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
